 ...
 */
package eu.dissco.demoprocessingservice.database.jooq.tables;


import eu.dissco.demoprocessingservice.database.jooq.Indexes;
import eu.dissco.demoprocessingservice.database.jooq.Keys;
...
public class DigitalSpecimen extends TableImpl<DigitalSpecimenRecord> {
     ...
     */
    public final TableField<DigitalSpecimenRecord, Curatedobjectidtypes> CURATED_OBJECT_ID_TYPE = createField(DSL.name("curated_object_id_type"), SQLDataType.VARCHAR.asEnumDataType(eu.dissco.demoprocessingservice.database.jooq.enums.Curatedobjectidtypes.class), this, "");
