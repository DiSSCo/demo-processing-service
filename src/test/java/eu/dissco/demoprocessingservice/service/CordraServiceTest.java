...
class CordraServiceTest {
  ...
  @Mock
  private CordraRepository cordraRepository;
  @Mock
...
//    this.service = new ProcessingService(cordraRepository, mapper, validationService, properties, kafkaPublishService);
...
//    given(cordraRepository.(anyString())).willReturn(loadResourceFile("test-empty-search.json"));
